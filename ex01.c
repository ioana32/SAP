...
//	pa = (unsigned char*)&y;
//
//	printf("Integer content of y location: ");
//	for (i = 0; i < sizeof(int); i++) // dump the left side of memory till a (low to high)
//		printf(" %02X ", pa[i]);
//	printf("\n");
//
//	return 0;
...
//		pV[i] = 0;
//
//	printf("Stack seg address where pV is allocated at compile-time = %p\n\
//		Heap seg address contained by location pV = %p\n", &pV, pV);
//	for (unsigned int i = 0; i < n; i++)
...
//	printf("\n");
//
//	free(pV);	// pV is not changed to NULL after
//	pV = NULL;
//	pV = &n;	// pV contains a stack seg mem address which is constant
//	// free(pV);	// stack segment memory addresses cannot be deallocated
//
//	return 0;
//}
